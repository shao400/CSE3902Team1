            ...
            foreach (IEnemy enemy in enemies)
            {
                ...
                if (!intersectionRectangle.IsEmpty && enemy.GetHealth() >0)
                {
                    ...
                    if (enemy.GetType() == oldman.GetType() && oldman.health!=0)
                    {
                        ...
                        enemy.Damaged();
                        if (enemy.GetHealth() == 0) s.enemyDie();
                        else s.enemyHit();                
                    }
                    //Normal Cases
                    myPlayer.takeDmg(1);
                    ...
                    {                     
                        ...
                        {
                            if (myPlayer.yAxis < IntegerHolder.FiveFiveTwo - intersectionRectangle.Height) myPlayer.yAxis += intersectionRectangle.Height;                           
                            else myPlayer.yAxis = IntegerHolder.FiveFiveTwo;
                        ...
                        {
                            if (myPlayer.yAxis > intersectionRectangle.Height) myPlayer.yAxis -= intersectionRectangle.Height;
                            else myPlayer.yAxis = IntegerHolder.TwoSixFour;                            
                    ...
                    else
                    {
                        ...
                        {
                            if (myPlayer.xAxis < IntegerHolder.SixTwoFour - intersectionRectangle.Width) myPlayer.xAxis += intersectionRectangle.Width;
                            else myPlayer.xAxis = IntegerHolder.SixTwoFour;
                            if (myPlayer.xAxis < 584) { myPlayer.xAxis += IntegerHolder.Fourty; } else { myPlayer.xAxis = IntegerHolder.SixTwoFour; }
                        }
                        else //from left
                        {
                            if (myPlayer.xAxis > intersectionRectangle.Width) myPlayer.xAxis -= intersectionRectangle.Width;
                            else myPlayer.xAxis = IntegerHolder.NinetySix;                            
