...
namespace Sprint0
{
    public class LinkMagicalRAttackingDownSprite: ISprite
    {
        ...
        public void Update()
        {
            ...
            {
                case 0:
                    sourceRec = new Rectangle(280, 47, 16, 16);
                    break;
                case 1:
                    sourceRec = new Rectangle(297, 47, 16, 27);
                    break;
                case 2:
                    sourceRec = new Rectangle(314, 47, 16, 23);
                    break;
                case 3:
                    sourceRec = new Rectangle(331, 47, 16, 19);
                    break;
                default:
                    break;
            }
