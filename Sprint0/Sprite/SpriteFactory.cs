...
namespace Sprint0.Sprite
{
    public static class SpriteFactory
    {
        ...
        public static HudWpSlotBorderSprite HudWpBorder = new HudWpSlotBorderSprite();
        ...
        private static void LoadHudContent(SpriteBatch batch, ContentManager content)
        {
            ...
            HudWpBorder.LoadContent(batch , content.Load<Texture2D>("Hud"));
